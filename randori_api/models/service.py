...
class Service(object):
    ...
    def __init__(self, applicability=None, confidence=None, criticality=None, deleted=None, description=None, enumerability=None, first_seen=None, id=None, instance_count=None, ip_count=None, last_seen=None, max_confidence=None, name=None, org_id=None, post_exploit=None, private_weakness=None, public_weakness=None, randori_notes=None, reference=None, research=None, service_id=None, tags=None, target_temptation=None, vendor=None, version=None):  # noqa: E501
