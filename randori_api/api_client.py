...
from randori_api import rest
from randori_api.configuration import Configuration
from randori_api.exceptions import ApiTypeError, ApiValueError, ApiException
from randori_api.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.add_affiliation  # this is an instance of the class Endpoint
        api_instance.add_affiliation()  # this invokes api_instance.add_affiliation.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.add_affiliation.callable or self.callable in this class
