...
class Tagcounts(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, all_count, content, hostname_count, id, ip_count, network_count, org_id, poc_count, service_count, target_count, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, all_count, content, hostname_count, id, ip_count, network_count, org_id, poc_count, service_count, target_count, *args, **kwargs):  # noqa: E501
        """Tagcounts - a model defined in OpenAPI
