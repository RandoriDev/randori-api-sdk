...
class UserApActionInstancesPatchIn(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, action_id, artifacts_status, bart_id, org_id, runbook_instance_id, started, updated, *args, **kwargs):  # noqa: E501
        """UserApActionInstancesPatchIn - a model defined in OpenAPI
