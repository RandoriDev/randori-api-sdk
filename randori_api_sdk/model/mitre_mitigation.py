...
class MitreMitigation(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, created, created_by_ref, description, external_references, id, modified, name, object_marking_refs, revoked, type, x_mitre_domains, x_mitre_modified_by_ref, x_mitre_version, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, created, created_by_ref, description, external_references, id, modified, name, object_marking_refs, revoked, type, x_mitre_domains, x_mitre_modified_by_ref, x_mitre_version, *args, **kwargs):  # noqa: E501
        """MitreMitigation - a model defined in OpenAPI
