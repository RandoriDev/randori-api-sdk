...
class ValidationpbStartValidationSeriesRequestMessageSource(ModelSimple):
    ...
    allowed_values = {
        ('value',): {
            'StartValidationSeriesRequest_User': 0,
        },
    }
    ...
    def __init__(self, *args, **kwargs):
        """ValidationpbStartValidationSeriesRequestMessageSource - a model defined in OpenAPI
