...
class CmspbExceptionPolicyWeekday(ModelSimple):
    ...
    allowed_values = {
        ('value',): {
            'ExceptionPolicy_Sunday': 0,
            'ExceptionPolicy_Monday': 1,
            'ExceptionPolicy_Tuesday': 2,
            'ExceptionPolicy_Wednesday': 3,
            'ExceptionPolicy_Thursday': 4,
            'ExceptionPolicy_Friday': 5,
            'ExceptionPolicy_Saturday': 6,
        },
    }
    ...
    def __init__(self, *args, **kwargs):
        """CmspbExceptionPolicyWeekday - a model defined in OpenAPI
