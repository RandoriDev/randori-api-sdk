...
class ApiToken(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, created_by, created_on, creator_id, label, org_id, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, created_by, created_on, creator_id, label, org_id, *args, **kwargs):  # noqa: E501
        """ApiToken - a model defined in OpenAPI
