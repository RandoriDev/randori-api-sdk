...
class AttackInterfacesForImplant(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, bart_id, id, implant_id, name, org_id, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, bart_id, id, implant_id, name, org_id, *args, **kwargs):  # noqa: E501
        """AttackInterfacesForImplant - a model defined in OpenAPI
