...
class AttackStatistics(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, current, index, latest, name, org_id, row_time, time, type, value, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, current, index, latest, name, org_id, row_time, time, type, value, *args, **kwargs):  # noqa: E501
        """AttackStatistics - a model defined in OpenAPI
