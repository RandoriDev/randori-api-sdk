...
class AuthorizationPolicy(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, created_at, edited_at, entity_types, filter_data, is_active, org_id, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, created_at, edited_at, entity_types, filter_data, is_active, org_id, *args, **kwargs):  # noqa: E501
        """AuthorizationPolicy - a model defined in OpenAPI
