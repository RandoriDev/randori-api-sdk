...
class ExternalCommentCreationSchema(BaseModel):
    """
    ExternalCommentCreationSchema
    """ # noqa: E501
    action: Optional[Dict[str, Any]] = None
    comment: Annotated[str, Field(min_length=1, strict=True, max_length=560)]
    entity_ids: Optional[List[StrictStr]] = None
    __properties: ClassVar[List[str]] = ["action", "comment", "entity_ids"]
