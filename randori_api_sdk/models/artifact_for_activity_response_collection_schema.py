...
class ArtifactForActivityResponseCollectionSchema(BaseModel):
    """
    ArtifactForActivityResponseCollectionSchema
    """ # noqa: E501
    count: Optional[StrictInt] = None
    data: Optional[List[ArtifactForActivityResponseSchema]] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "count": obj.get("count"),
            "data": [ArtifactForActivityResponseSchema.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None,
