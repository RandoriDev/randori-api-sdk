...
class CmspbFrontendSingleParameterResponse(BaseModel):
    """
    CmspbFrontendSingleParameterResponse
    """ # noqa: E501
    data: Optional[CmspbFrontendParameterObject] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": CmspbFrontendParameterObject.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
