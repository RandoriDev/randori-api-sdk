...
class CmspbFrontendListApplicableConfigurationsResponseApplicableConfiguration(BaseModel):
    """
    CmspbFrontendListApplicableConfigurationsResponseApplicableConfiguration
    """ # noqa: E501
    attributes: Optional[CmspbFrontendListApplicableConfigurationsResponseAttributes] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "attributes": CmspbFrontendListApplicableConfigurationsResponseAttributes.from_dict(obj.get("attributes")) if obj.get("attributes") is not None else None,
            "id": obj.get("id"),
            "type": obj.get("type")
        })
        return _obj
