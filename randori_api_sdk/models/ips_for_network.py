...
class IpsForNetwork(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["affiliation_state", "characteristic_tags", "confidence", "country", "deleted", "hostname", "id", "impact_score", "ip", "ip_id", "ip_str", "last_seen", "latitude", "lens_id", "lens_view", "longitude", "network", "network_id", "network_str", "open_port_count", "org_id", "perspective", "perspective_name", "radius", "service_count", "status", "target_count", "target_temptation", "user_tags"]
