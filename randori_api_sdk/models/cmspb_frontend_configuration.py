...
class CmspbFrontendConfiguration(BaseModel):
    """
    CmspbFrontendConfiguration
    """ # noqa: E501
    attributes: Optional[CmspbFrontendConfigurationAttributes] = None
    id: Optional[StrictStr] = None
    relationships: Optional[CmspbRelationships] = None
    type: Optional[CmspbFrontendType] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "attributes": CmspbFrontendConfigurationAttributes.from_dict(obj.get("attributes")) if obj.get("attributes") is not None else None,
            "id": obj.get("id"),
            "relationships": CmspbRelationships.from_dict(obj.get("relationships")) if obj.get("relationships") is not None else None,
            "type": obj.get("type")
        })
        return _obj
