...
class MitreTactic(BaseModel):
    ...
    type: StrictStr
    x_mitre_attack_spec_version: StrictStr
    x_mitre_domains: List[StrictStr]
    x_mitre_modified_by_ref: StrictStr
    x_mitre_shortname: StrictStr
    x_mitre_version: Union[StrictFloat, StrictInt]
    __properties: ClassVar[List[str]] = ["created", "created_by_ref", "description", "external_references", "id", "modified", "name", "object_marking_refs", "revoked", "spec_version", "type", "x_mitre_attack_spec_version", "x_mitre_domains", "x_mitre_modified_by_ref", "x_mitre_shortname", "x_mitre_version"]
