...
class IpsForService(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["affiliation_state", "confidence", "country", "deleted", "first_seen", "id", "impact_score", "ip", "ip_id", "ip_str", "last_seen", "latitude", "lens_id", "lens_view", "longitude", "open_port_count", "org_id", "perspective", "perspective_name", "radius", "service_count", "service_id", "status", "target_count", "target_temptation"]
