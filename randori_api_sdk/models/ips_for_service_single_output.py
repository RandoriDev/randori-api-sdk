...
class IpsForServiceSingleOutput(BaseModel):
    """
    IpsForServiceSingleOutput
    """ # noqa: E501
    data: Optional[IpsForService] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": IpsForService.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
