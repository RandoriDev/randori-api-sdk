...
class CmspbFrontendSingleConfigurationResponse(BaseModel):
    """
    CmspbFrontendSingleConfigurationResponse
    """ # noqa: E501
    data: Optional[CmspbFrontendConfiguration] = None
    links: Optional[CmspbFrontendLinksSelf] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": CmspbFrontendConfiguration.from_dict(obj.get("data")) if obj.get("data") is not None else None,
            "links": CmspbFrontendLinksSelf.from_dict(obj.get("links")) if obj.get("links") is not None else None
        })
        return _obj
