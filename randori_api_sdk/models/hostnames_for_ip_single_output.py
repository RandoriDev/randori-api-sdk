...
class HostnamesForIpSingleOutput(BaseModel):
    """
    HostnamesForIpSingleOutput
    """ # noqa: E501
    data: Optional[HostnamesForIp] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": HostnamesForIp.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
