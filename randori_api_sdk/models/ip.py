...
class Ip(BaseModel):
    ...
    hostname_count: Optional[StrictInt] = None
    ...
    __properties: ClassVar[List[str]] = ["affiliation_state", "all_ports", "authority", "authority_distance", "authority_override", "characteristic_tags", "confidence", "country", "deleted", "first_seen", "hostname_count", "hostnames", "id", "impact_score", "ip", "ip_str", "last_seen", "latitude", "lens_id", "lens_view", "longitude", "only_in_review_targets", "open_port_count", "org_id", "perspective", "perspective_name", "priority_impact_factor", "priority_score", "priority_status_factor", "priority_tags_factor", "radius", "service_count", "status", "target_count", "target_temptation", "user_tags"]
