...
class PreferenceOutCollection(BaseModel):
    """
    PreferenceOutCollection
    """ # noqa: E501
    preferences: Optional[List[PreferenceOut]] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "preferences": [PreferenceOut.from_dict(_item) for _item in obj.get("preferences")] if obj.get("preferences") is not None else None
        })
        return _obj
