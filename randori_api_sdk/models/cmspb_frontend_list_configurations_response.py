...
class CmspbFrontendListConfigurationsResponse(BaseModel):
    """
    CmspbFrontendListConfigurationsResponse
    """ # noqa: E501
    data: Optional[List[CmspbFrontendConfiguration]] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": [CmspbFrontendConfiguration.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None,
