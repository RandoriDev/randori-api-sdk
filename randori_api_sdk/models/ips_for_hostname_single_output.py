...
class IpsForHostnameSingleOutput(BaseModel):
    """
    IpsForHostnameSingleOutput
    """ # noqa: E501
    data: Optional[IpsForHostname] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": IpsForHostname.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
