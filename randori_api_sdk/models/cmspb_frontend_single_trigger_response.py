...
class CmspbFrontendSingleTriggerResponse(BaseModel):
    """
    CmspbFrontendSingleTriggerResponse
    """ # noqa: E501
    data: Optional[CmspbFrontendTriggerObject] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": CmspbFrontendTriggerObject.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
