...
class CommentResponseCollectionSchema(BaseModel):
    """
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "comments": [CommentResponseSchema.from_dict(_item) for _item in obj.get("comments")] if obj.get("comments") is not None else None
        })
        return _obj
