...
class AttackImplantsSingleOutput(BaseModel):
    """
    AttackImplantsSingleOutput
    """ # noqa: E501
    data: Optional[AttackImplants] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": AttackImplants.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
