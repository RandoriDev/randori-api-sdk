...
class SavedViewsPatchSingleInput(BaseModel):
    """
    SavedViewsPatchSingleInput
    """ # noqa: E501
    data: Optional[SavedViewsPatchIn] = None
    org_id: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["data", "org_id"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": SavedViewsPatchIn.from_dict(obj.get("data")) if obj.get("data") is not None else None,
