...
class CmspbFrontendConfigurationMitre(BaseModel):
    """
    CmspbFrontendConfigurationMitre
    """ # noqa: E501
    mitigations: Optional[List[StrictStr]] = None
    tactics: Optional[List[StrictStr]] = None
    techniques: Optional[List[StrictStr]] = None
    __properties: ClassVar[List[str]] = ["mitigations", "tactics", "techniques"]
