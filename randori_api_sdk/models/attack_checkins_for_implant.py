...
class AttackCheckinsForImplant(BaseModel):
    """
    ...
    org_id: StrictStr
    src_ip: StrictStr
    src_ip_str: StrictStr
    __properties: ClassVar[List[str]] = ["bart_id", "id", "implant_id", "last_checkin", "method", "org_id", "src_ip", "src_ip_str"]
