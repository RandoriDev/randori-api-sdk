...
class CmspbFrontendParameter(BaseModel):
    """
    ...
    is_not_set: Optional[StrictBool] = None
    is_optional: Optional[StrictBool] = None
    parameter: Optional[StrictStr] = None
    parameter_type: Optional[CmspbFrontendParameterKind] = None
    validation: Optional[CmspbFrontendValidation] = None
    value: Optional[StructpbValue] = None
    __properties: ClassVar[List[str]] = ["description", "field_label", "field_type", "is_configurable", "is_not_set", "is_optional", "parameter", "parameter_type", "validation", "value"]
