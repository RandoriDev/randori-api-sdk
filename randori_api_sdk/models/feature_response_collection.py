...
class FeatureResponseCollection(BaseModel):
    """
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "features": [FeatureResponse.from_dict(_item) for _item in obj.get("features")] if obj.get("features") is not None else None
        })
        return _obj
