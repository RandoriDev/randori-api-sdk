...
class IpsForNetworkSingleOutput(BaseModel):
    """
    IpsForNetworkSingleOutput
    """ # noqa: E501
    data: Optional[IpsForNetwork] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": IpsForNetwork.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
