...
class CmspbFrontendConfigurationAccessEntry(BaseModel):
    """
    CmspbFrontendConfigurationAccessEntry
    """ # noqa: E501
    author_id: Optional[StrictStr] = None
    var_date: Optional[TimestamppbTimestamp] = Field(default=None, alias="date")
    __properties: ClassVar[List[str]] = ["author_id", "date"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "date": TimestamppbTimestamp.from_dict(obj.get("date")) if obj.get("date") is not None else None
        })
        return _obj
