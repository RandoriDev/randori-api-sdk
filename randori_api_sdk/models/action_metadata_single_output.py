...
class ActionMetadataSingleOutput(BaseModel):
    """
    ActionMetadataSingleOutput
    """ # noqa: E501
    data: Optional[ActionMetadata] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": ActionMetadata.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
