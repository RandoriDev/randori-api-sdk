...
class SocialEntityPatchInput(BaseModel):
    """
    SocialEntityPatchInput
    """ # noqa: E501
    data: Optional[SocialEntityPatchIn] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": SocialEntityPatchIn.from_dict(obj.get("data")) if obj.get("data") is not None else None,
