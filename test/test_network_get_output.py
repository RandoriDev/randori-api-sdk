...
class TestNetworkGetOutput(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> NetworkGetOutput:
        """Test NetworkGetOutput
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkGetOutput`
        """
        model = NetworkGetOutput()
        if include_optional:
            return NetworkGetOutput(
                count = 56,
                data = [
                    randori_api_sdk.models.network.network(
