...
class TestAttackInterfacesForImplantGetOutput(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> AttackInterfacesForImplantGetOutput:
        """Test AttackInterfacesForImplantGetOutput
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AttackInterfacesForImplantGetOutput`
        """
        model = AttackInterfacesForImplantGetOutput()
        if include_optional:
            return AttackInterfacesForImplantGetOutput(
                count = 56,
                data = [
                    randori_api_sdk.models.attack_interfaces_for_implant.attack-interfaces-for-implant(
                        address = '', 
                        bart_id = '', 
                        id = '', 
                        implant_id = '', 
