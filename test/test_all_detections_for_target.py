...
class TestAllDetectionsForTarget(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> AllDetectionsForTarget:
        """Test AllDetectionsForTarget
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AllDetectionsForTarget`
        """
        model = AllDetectionsForTarget()
        if include_optional:
