...
class TestAttackImplantsGetOutput(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> AttackImplantsGetOutput:
        """Test AttackImplantsGetOutput
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AttackImplantsGetOutput`
        """
        model = AttackImplantsGetOutput()
        if include_optional:
            return AttackImplantsGetOutput(
                count = 56,
                data = [
                    randori_api_sdk.models.attack_implants.attack-implants(
                        arch = '', 
                        bart_id = '', 
                        bits = 56, 
