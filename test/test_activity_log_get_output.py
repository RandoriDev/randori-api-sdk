...
class TestActivityLogGetOutput(unittest.TestCase):
    """ActivityLogGetOutput unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ActivityLogGetOutput:
        """Test ActivityLogGetOutput
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ActivityLogGetOutput`
        """
        model = ActivityLogGetOutput()
        if include_optional:
            return ActivityLogGetOutput(
                count = 56,
                data = [
                    randori_api_sdk.models.activity_log.activity-log(
    ...
    def testActivityLogGetOutput(self):
        """Test ActivityLogGetOutput"""
