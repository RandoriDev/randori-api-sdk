...
class TestHostnameGetOutput(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> HostnameGetOutput:
        """Test HostnameGetOutput
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HostnameGetOutput`
        """
        model = HostnameGetOutput()
        if include_optional:
            return HostnameGetOutput(
                count = 56,
                data = [
                    randori_api_sdk.models.hostname.hostname(
