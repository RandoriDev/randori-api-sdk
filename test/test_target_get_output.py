...
class TestTargetGetOutput(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> TargetGetOutput:
        """Test TargetGetOutput
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TargetGetOutput`
        """
        model = TargetGetOutput()
        if include_optional:
            return TargetGetOutput(
                count = 56,
                data = [
                    randori_api_sdk.models.target.target(
