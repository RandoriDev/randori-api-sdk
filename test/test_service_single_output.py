...
class TestServiceSingleOutput(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ServiceSingleOutput:
        """Test ServiceSingleOutput
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ServiceSingleOutput`
        """
        model = ServiceSingleOutput()
        if include_optional:
            return ServiceSingleOutput(
                data = randori_api_sdk.models.service.service(
                    applicability = 56, 
                    attack_note = '', 
                    confidence = 56, 
