...
class TestAllDetectionsForTargetGetOutput(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> AllDetectionsForTargetGetOutput:
        """Test AllDetectionsForTargetGetOutput
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AllDetectionsForTargetGetOutput`
        """
        model = AllDetectionsForTargetGetOutput()
        if include_optional:
            return AllDetectionsForTargetGetOutput(
                count = 56,
                data = [
                    randori_api_sdk.models.all_detections_for_target.all-detections-for-target(
