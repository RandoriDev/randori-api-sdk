...
class TestAttackCheckinsForImplant(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> AttackCheckinsForImplant:
        """Test AttackCheckinsForImplant
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AttackCheckinsForImplant`
        """
        model = AttackCheckinsForImplant()
        if include_optional:
