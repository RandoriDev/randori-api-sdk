...
class TestTagcountsSingleOutput(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> TagcountsSingleOutput:
        """Test TagcountsSingleOutput
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TagcountsSingleOutput`
        """
        model = TagcountsSingleOutput()
        if include_optional:
            return TagcountsSingleOutput(
                data = randori_api_sdk.models.tagcounts.tagcounts(
                    all_count = 56, 
                    content = '', 
                    hostname_count = 56, 
                    id = '', 
