...
class TestIpsForServiceGetOutput(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> IpsForServiceGetOutput:
        """Test IpsForServiceGetOutput
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IpsForServiceGetOutput`
        """
        model = IpsForServiceGetOutput()
        if include_optional:
            return IpsForServiceGetOutput(
                count = 56,
                data = [
                    randori_api_sdk.models.ips_for_service.ips-for-service(
