...
class TestCmspbApplicableEntities(unittest.TestCase):
    """CmspbApplicableEntities unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CmspbApplicableEntities:
        """Test CmspbApplicableEntities
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CmspbApplicableEntities`
        """
        model = CmspbApplicableEntities()
        if include_optional:
            return CmspbApplicableEntities(
                data = [
    ...
    def testCmspbApplicableEntities(self):
        """Test CmspbApplicableEntities"""
