...
class TestSingleDetectionForTargetGetOutput(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SingleDetectionForTargetGetOutput:
        """Test SingleDetectionForTargetGetOutput
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SingleDetectionForTargetGetOutput`
        """
        model = SingleDetectionForTargetGetOutput()
        if include_optional:
            return SingleDetectionForTargetGetOutput(
                count = 56,
                data = [
                    randori_api_sdk.models.single_detection_for_target.single-detection-for-target(
