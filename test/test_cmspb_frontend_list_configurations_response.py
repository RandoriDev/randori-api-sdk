...
class TestCmspbFrontendListConfigurationsResponse(unittest.TestCase):
    """CmspbFrontendListConfigurationsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CmspbFrontendListConfigurationsResponse:
        """Test CmspbFrontendListConfigurationsResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CmspbFrontendListConfigurationsResponse`
        """
        model = CmspbFrontendListConfigurationsResponse()
        if include_optional:
            return CmspbFrontendListConfigurationsResponse(
                data = [
                    randori_api_sdk.models.cmspb/frontend_configuration.cmspb.FrontendConfiguration(
    ...
    def testCmspbFrontendListConfigurationsResponse(self):
        """Test CmspbFrontendListConfigurationsResponse"""
