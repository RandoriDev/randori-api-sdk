...
class TestIpSingleOutput(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> IpSingleOutput:
        """Test IpSingleOutput
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IpSingleOutput`
        """
        model = IpSingleOutput()
        if include_optional:
            return IpSingleOutput(
                data = randori_api_sdk.models.ip.ip(
